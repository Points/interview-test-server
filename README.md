...
Your task is to build an app against a small API. You can [download the docker image](#Getting-started) onto your computer and run it locally. 
...
Your task is to build an application that queries our dockerized API and calculate the total income tax for a given salary and tax year.
...
The goal of this assessment is to provide with a picture of your approach to development as it relates to:
